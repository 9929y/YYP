...
(function () {
  ...
  var CSS = [
    ...
    /* Figma Glass-canva: rgba(255,255,255,0.9) + blur 100px */
    '  --yy-panel-fill: rgba(255,255,255,.90);',
    ...
    '  max-width: none;',
    '}',
    /* Figma Glass-canva — same recipe for Work / About / Resume */
    '.panel{',
    ...
    '  box-shadow:',
    '    inset 0 0 20px 10px rgba(255,255,255,.20),',
    '    inset 0 15px 20px 0 rgba(255,255,255,.13),',
    '    0 5px 50px 5px rgba(0,0,0,.25);',
    ...
    /* Work uses the same Figma glass as About / Resume */
    '.panel.is-work{',
