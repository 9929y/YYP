...
(function () {
  ...
  var CSS = [
    ...
    '  --yy-panel-height: calc(100vh - var(--yy-nav-zone) - 24px);',
    '  --yy-panel-height: calc(100dvh - var(--yy-nav-zone) - 24px);',
    ...
    '  .panel-stack{',
    '    --yy-nav-zone: 64px;',
    '    --yy-panel-height: calc(100vh - var(--yy-nav-zone) - 20px);',
    '    --yy-panel-height: calc(100dvh - var(--yy-nav-zone) - 20px);',
    ...
    '  .panel-stack{',
    '    --yy-nav-zone: 72px;',
    '    --yy-panel-height: calc(100vh - var(--yy-nav-zone) - 16px);',
    '    --yy-panel-height: calc(100dvh - var(--yy-nav-zone) - 16px);',
    '  }',
